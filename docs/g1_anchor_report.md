...
kinetic parameter touched (§5.1). **`biogas_mean` is 1.35** against [0.6, 1.5] at the
...
centre derived the same way — with the band unchanged; the anchor column is total metered
...
| `biogas_mean` | m3/d per digester at the meter's conditions | 2860 | 2111 | 1.35 | ratio in [0.6, 1.5] | pass |
| `digester_pH_median` | pH units | 7.233 | 7.27 | 0.99 | +/- 0.4 pH units | pass |
| `alkalinity_median` | kg CaCO3/m3 | 5.063 | 5.043 | 1.00 | +/- 35 % | calibrated to anchor |
| `vfa_median` | kg/m3 as acetic acid | 0.7598 | 1.178 | 0.64 | ratio in [0.25, 4] | pass |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1000 | sound | 7.31 | 0.670 | 0.935 | 0.0894 | 0.150 | 7.60 % | 6.43 % | 0.00 % | 0.00 % |
| 1001 | sound | 7.21 | 0.687 | 0.711 | 0.0637 | 0.152 | 4.68 % | 4.68 % | 0.00 % | 0.00 % |
| 1002 | sound | 7.26 | 0.684 | 0.797 | 0.0744 | 0.152 | 9.36 % | 8.77 % | 0.00 % | 0.00 % |
| 1003 | sound | 7.21 | 0.643 | 0.804 | 0.0692 | 0.152 | 6.43 % | 6.43 % | 0.00 % | 0.00 % |
| 1004 | sound | 7.23 | 0.685 | 0.735 | 0.0637 | 0.151 | 7.02 % | 5.26 % | 0.00 % | 0.00 % |
| 1005 | sound | 7.22 | 0.678 | 0.741 | 0.0632 | 0.151 | 7.02 % | 10.53 % | 0.00 % | 0.00 % |
| 1006 | sound | 7.20 | 0.687 | 0.680 | 0.0587 | 0.152 | 4.09 % | 2.92 % | 0.00 % | 0.00 % |
| 1007 | sound | 7.34 | 0.683 | 0.949 | 0.0805 | 0.148 | 7.60 % | 4.68 % | 0.00 % | 0.00 % |
| 1008 | sound | 7.21 | 0.664 | 0.737 | 0.0635 | 0.152 | 19.88 % | 13.45 % | 0.00 % | 0.00 % |
| 1009 | sound | 7.22 | 0.666 | 0.746 | 0.0611 | 0.151 | 10.53 % | 9.94 % | 0.00 % | 0.00 % |
| 1010 | sound | 7.24 | 0.682 | 0.756 | 0.0656 | 0.151 | 2.92 % | 1.75 % | 0.00 % | 0.00 % |
| 1011 | sound | 7.30 | 0.682 | 0.879 | 0.0773 | 0.150 | 5.85 % | 4.68 % | 0.00 % | 0.00 % |
| 1012 | sound | 7.30 | 0.685 | 0.848 | 0.0713 | 0.148 | 5.26 % | 6.43 % | 0.00 % | 0.00 % |
| 1013 | sound | 7.23 | 0.674 | 0.759 | 0.0690 | 0.151 | 9.36 % | 8.19 % | 0.00 % | 0.00 % |
| 1014 | sound | 7.25 | 0.677 | 0.761 | 0.0613 | 0.149 | 8.77 % | 8.77 % | 0.00 % | 0.00 % |
| 1015 | sound | 7.23 | 0.692 | 0.729 | 0.0776 | 0.153 | 7.02 % | 4.09 % | 0.00 % | 0.00 % |
| 1016 | sound | 7.23 | 0.662 | 0.788 | 0.0635 | 0.151 | 4.09 % | 2.92 % | 0.00 % | 0.00 % |
| 1017 | sound | 7.28 | 0.691 | 0.803 | 0.0696 | 0.150 | 5.85 % | 3.51 % | 0.00 % | 0.00 % |
| 1018 | sound | 7.29 | 0.685 | 0.849 | 0.0862 | 0.152 | 10.53 % | 7.60 % | 0.00 % | 0.00 % |
| 1019 | sound | 7.24 | 0.680 | 0.747 | 0.0621 | 0.151 | 7.60 % | 5.85 % | 0.00 % | 0.00 % |
| 1020 | sound | 7.23 | 0.661 | 0.791 | 0.0606 | 0.150 | 5.85 % | 6.43 % | 0.00 % | 0.00 % |
| 1021 | sound | 7.21 | 0.664 | 0.740 | 0.0579 | 0.151 | 9.36 % | 11.11 % | 0.00 % | 0.00 % |
| 1022 | sound | 7.19 | 0.667 | 0.744 | 0.0822 | 0.156 | 2.92 % | 1.75 % | 0.00 % | 0.00 % |
| 1023 | sound | 7.32 | 0.682 | 0.911 | 0.0910 | 0.151 | 7.60 % | 5.85 % | 0.00 % | 0.00 % |
...
|---|---|---:|---:|---:|---:|
| **overload trigger** (conditional missingness) | hidden true VFA > 2.00x its 30-d trailing median | **7.38 %** | 2.92 % | 19.88 % | 24 of 24 |
| **foaming trigger** (conditional missingness) | hidden gas > 1.80x its 30-d trailing median AND true VFA > its 30-d trailing median | **6.34 %** | 1.75 % | 13.45 % | 24 of 24 |
...
|---|---|---:|---|---:|---|---:|---:|---:|
| **B** | — | 200 d | 24/24 | **7.38 %** | 2.92 – 19.88 % | 24/24 | — | 0.00 % |
...
and FOG degradability centres to their cited values (before ruling 5: B 7.12 %, 2.34 –
16.37 %, 24/24; C 9.82 %, 6.43 – 14.04 %, 24/24; Plant C's feed has neither stream, and its
rows are unchanged to the last digit); the VFA-ratio p92 column
...
|---|---|---:|---|---:|---|---:|---:|
| **B** | — | 200 d | 24/24 | **6.34 %** | 1.75 – 13.45 % | 24/24 | 0.00 % |
...
(B re-measured after ruling 5, as above; before it 6.63 %, 1.75 – 14.04 %, 24/24).
