...
* **`S4-02` has something to scale** (settled 2026-09-09/10; this entry once said the
  ...
  24 sound Plant B runs at the 200-d matrix horizon they fire on 7.55 % and
  6.60 % of days, in every run (7.12 % and 6.63 % before the lead's ruling 5 of
  2026-09-11 corrected the HSW and FOG degradability centres and its answer A set FOG's
  inert COD equivalent to 2.9), against the
